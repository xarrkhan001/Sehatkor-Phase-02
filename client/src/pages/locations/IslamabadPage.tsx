...
const IslamabadPage = () => {
    return (
        <div className="min-h-screen bg-gradient-to-br from-purple-50 to-white">
            <SEO
                title="Best Doctors in Islamabad | اسلام آباد میں ڈاکٹر | Sehatkor"
                description="Find and book 600+ top-rated PMDC verified doctors in Islamabad (F-6, F-7, F-8, F-10, F-11). 24/7 doctor appointments and healthcare services on Sehatkor."
                keywords="doctors in Islamabad, best doctor Islamabad, Islamabad doctor appointment, F-6 doctor, F-7 hospital, Shifa International Islamabad"
            />
