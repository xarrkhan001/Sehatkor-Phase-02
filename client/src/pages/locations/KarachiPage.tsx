...
const KarachiPage = () => {
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-blue-50 to-white">
            <SEO
                title="Best Doctors in Karachi | آنلائن ڈاکٹر کراچی | Sehatkor"
                description="Find and book 1000+ top-rated PMDC verified doctors in Karachi (DHA, Clifton, Gulshan). 24/7 doctor appointments, urgent care, and health services on Sehatkor."
                keywords="doctors in Karachi, best doctor Karachi, Karachi doctor appointment, DHA doctor, Clifton hospital, کراچی ڈاکٹر, Aga Khan hospital Karachi"
            />
