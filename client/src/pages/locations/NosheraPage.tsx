        ...
        <div className="min-h-screen bg-gradient-to-br from-amber-50 to-white">
                ...
                <div className="container mx-auto px-6">
                    <div className="max-w-4xl mx-auto text-center">
                        <div className="flex items-center justify-center gap-3 mb-6">
                            ...
                            <h1 className="text-4xl lg:text-5xl font-bold">Doctor Appointments in Noshera</h1>
                        </div>
                        <p className="text-xl mb-8 opacity-90">
                            Book verified doctors, hospitals, labs, and pharmacies in Noshera. 24/7 service available.
                        </p>
                        <div className="flex flex-wrap justify-center gap-4">
                            <span className="bg-white/20 px-4 py-2 rounded-full text-sm">100+ Doctors</span>
                            <span className="bg-white/20 px-4 py-2 rounded-full text-sm">6+ Hospitals</span>
                            <span className="bg-white/20 px-4 py-2 rounded-full text-sm">5+ Labs</span>
            ...
            <div className="container mx-auto px-6 py-16">
                ...
                <section className="mb-16">
                    <h2 className="text-3xl font-bold text-gray-900 mb-8 text-center">Healthcare Services in Noshera</h2>
                        ...
                        {[
                            {
                                ...
                                icon: Users,
                                areas: ["Noshera City", "Mansa", "Amazai", "Pir Sabak"]
                            },
                            {
                                title: "Hospital Booking",
                                desc: "Admissions, surgeries, and emergency care",
                                icon: ShieldCheck,
                                areas: ["District Headquarters Hospital", "Tehsil Hospital", "Private Clinics"]
                            },
                            {
                                title: "Lab Tests",
                                ...
                                <div key={index} className="bg-white rounded-xl p-6 shadow-lg border border-gray-100">
                                    ...
                                    <div className="flex flex-wrap gap-2">
                                        {service.areas.map((area, i) => (
                                            <span key={i} className="text-xs px-2 py-1 bg-rose-50 text-rose-700 rounded-md">
                                                {area}
                                            </span>
                                        ))}
                                    </div>
                ...
                {/* Popular Areas */}
                <section className="mb-16">
                    <h2 className="text-3xl font-bold text-gray-900 mb-8 text-center">Popular Areas in Noshera</h2>
                    <div className="grid md:grid-cols-3 gap-4">
                        {[
                            "Noshera City", "Mansa", "Amazai", "Pir Sabak",
                            "Khushab", "Munda", "Jahangira", "Noorpur"
                        ].map((area, index) => (
                            <div key={index} className="bg-white rounded-lg p-4 border border-gray-200 text-center hover:border-rose-300 transition-colors">
                ...
                <section className="bg-gradient-to-r from-rose-600 to-pink-600 rounded-2xl p-8 text-center text-white">
                    <h2 className="text-2xl font-bold mb-4">Book Your Doctor Appointment in Noshera</h2>
                    <p className="text-lg mb-6 opacity-90">
                        Join thousands of Noshera residents who trust SehatKor for their healthcare needs
                    </p>
                    <div className="flex flex-col sm:flex-row gap-4 justify-center">
                        <Link
                            to="/search?location=noshera"
                            className="bg-white text-rose-600 hover:bg-gray-50 px-6 py-3 rounded-lg font-semibold"
                        >
                            Search Doctors in Noshera
                        </Link>
                        <Link
                            to="/register"
                            className="border border-white text-white hover:bg-white hover:text-rose-600 px-6 py-3 rounded-lg font-semibold"
                        >
                            Create Free Account
                        </Link>
                    </div>
