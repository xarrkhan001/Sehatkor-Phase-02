        ...
        <div className="min-h-screen bg-gradient-to-br from-orange-50 to-white">
                ...
                <div className="container mx-auto px-6">
                    <div className="max-w-4xl mx-auto text-center">
                        <div className="flex items-center justify-center gap-3 mb-6">
                            ...
                            <h1 className="text-4xl lg:text-5xl font-bold">Doctor Appointments in Peshawar</h1>
                        </div>
                        <p className="text-xl mb-8 opacity-90">
                            Book verified doctors, hospitals, labs, and pharmacies in Peshawar. 24/7 service available.
                        </p>
                        <div className="flex flex-wrap justify-center gap-4">
                            <span className="bg-white/20 px-4 py-2 rounded-full text-sm">400+ Doctors</span>
                            <span className="bg-white/20 px-4 py-2 rounded-full text-sm">20+ Hospitals</span>
                            <span className="bg-white/20 px-4 py-2 rounded-full text-sm">15+ Labs</span>
            ...
            <div className="container mx-auto px-6 py-16">
                ...
                <section className="mb-16">
                    <h2 className="text-3xl font-bold text-gray-900 mb-8 text-center">Healthcare Services in Peshawar</h2>
                    <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
                        {[
                            ...
                            },
                            {
                                ...
                                icon: ShieldCheck,
                                areas: ["Khyber Teaching Hospital", "Lady Reading Hospital", "Hayatabad Medical Complex"]
                            },
                            {
                                title: "Lab Tests",
                ...
                {/* Popular Areas */}
                <section className="mb-16">
                    <h2 className="text-3xl font-bold text-gray-900 mb-8 text-center">Popular Areas in Peshawar</h2>
                    <div className="grid md:grid-cols-3 gap-4">
                        {[
                            "University Town", "Hayatabad", "Cantt", "Karkhano Market",
                            "Defence Colony", "Phase 1", "Phase 2", "Phase 3"
                        ].map((area, index) => (
                            <div key={index} className="bg-white rounded-lg p-4 border border-gray-200 text-center hover:border-orange-300 transition-colors">
                ...
                <section className="bg-gradient-to-r from-orange-600 to-red-600 rounded-2xl p-8 text-center text-white">
                    <h2 className="text-2xl font-bold mb-4">Book Your Doctor Appointment in Peshawar</h2>
                    <p className="text-lg mb-6 opacity-90">
                        Join thousands of Peshawar residents who trust SehatKor for their healthcare needs
                    </p>
                    <div className="flex flex-col sm:flex-row gap-4 justify-center">
                        <Link
                            to="/search?location=peshawar"
                            className="bg-white text-orange-600 hover:bg-gray-50 px-6 py-3 rounded-lg font-semibold"
                        >
                            Search Doctors in Peshawar
                        </Link>
                        <Link
                            to="/register"
                            className="border border-white text-white hover:bg-white hover:text-orange-600 px-6 py-3 rounded-lg font-semibold"
                        >
                            Create Free Account
                        </Link>
                    </div>
