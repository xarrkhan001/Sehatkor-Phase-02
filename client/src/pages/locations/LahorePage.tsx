...
const LahorePage = () => {
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-green-50 to-white">
            <SEO
                title="Best Doctors in Lahore | لاہور میں ڈاکٹر | Sehatkor"
                description="Find and book 800+ top-rated PMDC verified doctors in Lahore (Gulberg, DHA, Model Town, Johar Town). 24/7 doctor appointments and health services on Sehatkor."
                keywords="doctors in Lahore, best doctor Lahore, Lahore doctor appointment, Gulberg doctor, DHA Lahore, لاہور ڈاکٹر, Shaukat Khanum Lahore"
            />
