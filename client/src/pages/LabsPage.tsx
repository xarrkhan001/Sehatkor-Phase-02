...
import { MapPin, Minimize2, Maximize2, X, Search, Home, Clock, Star, Share2 } from "lucide-react";
      ...
      <div className="container mx-auto px-4 py-4">
        ...
        <div className="grid gap-3 grid-cols-1 sm:grid-cols-3 lg:grid-cols-4">
          {filteredServices.map((service) => (
            <Card
              key={service.id}
              className="shadow-sm hover:shadow-md transition-shadow duration-200 rounded-none border border-gray-200 hover:border-blue-200 transition-colors bg-white h-full flex flex-col"
            >
